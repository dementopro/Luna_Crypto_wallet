...
public class SelectSwapProvidersViewModel extends BaseViewModel
{
    ...
    public Set<String> getPreferredExchanges()
    {
        ...
        {
            List<SwapProvider> swapProviders = getSwapProviders(true);
    ...
    public List<SwapProvider> getSwapProviders(boolean isMoreShow)
    {
        List<SwapProvider> swapProviders = swapRepository.getProviders();

        List<SwapProvider> sliceProviders = swapProviders.subList(0, 5);

        if (sliceProviders != null)
        {
        ...
        if(isMoreShow == true) return swapProviders;
